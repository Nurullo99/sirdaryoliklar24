      ...
      <div class="container">
        <div class="basic-flex header__top">
          ...
          <div class="header__actions basic-flex">
            ...
            <div class="telegram-join basic-flex">
              <a href="#"><img src="/img/tg.png" alt="Telegram">@lang('words.Подписатся')</a>
            </div>
          </div>
        </div>
       ...
       <a href="{{ $ad->url_1 }}" class="advertisement-box" style="background-image: url(/site/images/ads/{{ $ad->image_1 }});">
          <h4>{{ $ad->title_1 }}</h4>
        </a> 
      </div>
    </header>
...
<footer class="footer">
    <div class="container">
      <div class="footer__top basic-flex">
        <a href="{{ route('index') }}" class="footer_logo"><img src="/img/3 sirdaryo.qayta.svg" alt="SIRDARYOLIKLAR@$"></a>
        <div class="join-telegram-wrapper basic-flex">
          <p>@lang('words.Подписывайтесь на наш канал в Telegram и будьте всегда в курсе самых последних новостей:')</p>
          <a href="#" class="join-telegram">@lang('words.Подписатся')</a>
        </div>
      </div>
      <div class="footer__bottom">
        <div class="about-site">
          <h4>@lang('words.О сайте')</h4>
          <p>@lang('words.Воспроизводство, копирование, тиражирование, распространение и иное использование информации с сайта «SIRDARYO24.UZ» возможно только с предварительного письменного разрешения редакции.')</p>
        </div>
        <ul class="footer-menu">
          <li class="footer-menu__item"><a href="#" class="footer-menu__link">@lang('words.Информация о сайте')</a></li>
          <li class="footer-menu__item"><a href="{{ route('contact') }}" class="footer-menu__link">@lang('words.Напишите нам')</a></li>
          <li class="footer-menu__item"><a href="#" class="footer-menu__link">@lang('words.Реклама')</a></li>
          <li class="footer-menu__item"><a href="#" class="footer-menu__link">@lang('words.Прислать новость')</a></li>
        </ul>
        <ul class="footer-menu">
          <li class="footer-menu__item"><a href="#" class="footer-menu__link">@lang('words.Использование материалов') </a></li>
          <li class="footer-menu__item"><a href="#" class="footer-menu__link">@lang('words.Темы дня')</a></li>
          <li class="footer-menu__item"><a href="#" class="footer-menu__link">@lang('words.Наша команда')</a></li>
        </ul>
      </div>
    </div>
  </footer>
